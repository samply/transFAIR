...
public class ObservationBuilder extends ResourceBuilder {
    ...
    private void addIsolateIdExtension(Observation observation, String isolateId) {
        observation.addExtension(createStringExtension(isolateId, "https://bbmri.crc/fhir/StructureDefinition/ObservationIsolateId"));
    }
    ...
    private void addDataSourceExtension(Observation observation, String dataSource) {
        observation.addExtension(createStringExtension(dataSource, "https://bbmri.crc/fhir/StructureDefinition/ObservationDataSource"));
    }
    ...
    private void addPatientTypeExtension(Observation observation, String patientType) {
        observation.addExtension(createStringExtension(patientType, "https://bbmri.crc/fhir/StructureDefinition/ObservationPatientType"));
    }
    ...
    private void addReportingCountryExtension(Observation observation, String reportingCountry) {
        observation.addExtension(createStringExtension(reportingCountry, "https://bbmri.crc/fhir/StructureDefinition/ObservationReportingCountry"));
    }
    ...
    private void addReferenceGuidelinesSirExtension(Observation observation, String referenceGuidelinesSir) {
        observation.addExtension(createStringExtension(referenceGuidelinesSir, "https://bbmri.crc/fhir/StructureDefinition/ObservationReferenceGuidelinesSIR"));
    }
    ...
    private CodeableConcept constructObjectValueCodeableConcept(String pathogen, String antibiotic, String sir) {
        ...
        pathogenCoding.setSystem("https://bbmri.crc/pathogen-codes"); // Replace with the actual system URI
        ...
        antibioticCoding.setSystem("https://bbmri.crc/antibiotic-codes"); // Replace with the actual system URI
        antibioticCoding.setCode(antibiotic);
        codeableConcept.addCoding(antibioticCoding);
        // Add coding for SIR
        Coding sirCoding = new Coding();
        sirCoding.setSystem("https://bbmri.crc/sir-codes"); // Replace with the actual system URI
