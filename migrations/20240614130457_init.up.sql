...
BEGIN
    INSERT INTO _data_requests_history (_rowid, id, exchange_id, status, message, _version, _updated)
    VALUES (new.rowid, new.id, new.exchange_id, new.status, new.message, 1, cast((julianday('now') - 2440587.5) * 86400 * 1000 as integer));
END;
